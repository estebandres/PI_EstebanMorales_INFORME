...
Todos estos cerramientos eléctricos no funcionan por si mismos sino que requieren de un dispositivo controlador.
...
Una llave electrónica es un dispositivo electrónico que le permite al usuario operar el cerramiento eléctrico. Existen diversos tipos de llaves electrónicas pero sólo se mencionan las más utilizadas.
\begin{itemize}
	\item Llaves RFID
...
Una etiqueta RFID consiste en un pequeño circuito receptor y transmisor de radio. Cuando se activa por un pulso de interrogación electromagnético de un dispositivo lector de RFID cercano, la etiqueta transmite datos digitales, generalmente un número identificatorio de vuelta al lector.
...
RF es el acrónimo de Radio-Frequency y hace referencia a las tecnologías que emplean sistemas de comunicación por emisión de ondas electromagnéticas. Por lo general se utilizan anchos de bandas libres sin restricciones gubernamentales con potencias de transmisión baja.
En el caso del control remoto por RF un código numérico identificatorio se transmite al controlador que incluye un circuito receptor comúnmente en las frecuencias que van de los 200 MHz a los 500 Mhz. El rango de acción de estos dispositivos es de aproximadamente 100 mts en línea de visión.
...
Tanto el empleo de llaves RFID como controles RF presentan un problema de seguridad en estos sistemas de acceso electrónico. Conceden acceso a quien porta el token de identificación sin importar si se trata del dueño real.
...
\textbf{Inhibición de Señal:} Esta técnica implica la utilización de un transmisor que contamina con ruido el ancho de banda de operación del control remoto impidiendo la correcta comunicación con el controlador del cerramiento.
...
Estos productos proponen la instalación y configuración de una red de sensores (comúnmente inalámbricos) en una topología tipo estrella. En el centro de la red se encuentra un dispositivo electrónico denominado \textit{gateway} que posee al menos dos interfaces de comunicación principales, una para conectarse a la red de sensores y otra para acceder a internet. Esta ''central'' o gateway recibe las actualizaciones de estado de los sensores y las reenvía por internet al servicio de monitoreo.
...
Estos dispositivos incluyen el sistema embebido capaz de conectarse a internet a través de WiFi o Bluetooth (mediante el uso de un gateway).
En todos los casos se ofrece una aplicación móvil que hace de llave virtual y permite el acceso a estos cerramientos inteligentes.
...
Para el caso de los portones de garaje existen diversas implementaciones que agregan estos objetos a la familia de productos IoT.\\
Debido a que la mayoría de los controladores ofrecen al menos una interfaz para conexión de botón externo para apertura y cierre. Diversas sturtups desarrollaron implementaciones de dispositivos a modo de accesorios compatibles con una familia de controladores. Este es el caso de ISmartGate, Nexx NXG-100 y Garadget.\\
Luego los fabricantes más importantes de controladores y motores para portones de garaje de estados unidos realizaron sus propias implementaciones y las incorporaron a sus controladores como una funcionalidad built-in. Este es el caso de la empresa Genie con su linea de productos Aladdin. Por otro lado la empresa Chamberlane optó por el enfoque de agregar la misma funcionalidad mediante el uso accesorios que ofrecen con su línea myQ.\\
