...
\begin{figure}[htbp]
	...
	\rule{35em}{1pt}
	\caption[Connection Diagram]{Diagrama de clases de una unidad funcional.}
...
\begin{Figure}%[b]
	...
	\rule{\linewidth}{1pt}
	\captionof{figure}{Diagrama de clases de una unidad funcional.}
	\label{fig:dir_unit}
\end{Figure}
...
\begin{multicols}{2}
	\begin{Figure}%[htbp]
		...
		\rule{\linewidth}{1pt}
		\captionof{figure}{Subconjuntos de Casos de Uso para cadad Iteración.}
