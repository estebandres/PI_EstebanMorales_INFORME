...
Este esquema requiere la realización de un intercambio inicial entre el Módulo y la Aplicación para verificar las credenciales. El procedimiento se describe a continuación, un ejemplo detallado se muestra en la figura ~\ref{fig:digest_auth_seq}.
\begin{enumerate}
...
\begin{figure}[htbp]
	...
	\rule{35em}{1pt}
	\caption[Connection Diagram]{Secuencia de la autenticación utilizando Digest Authentication.}
...
\begin{figure}[htbp]
	...
	\rule{35em}{1pt}
	\caption[Connection Diagram]{Secuencia del envío de mensajes par $QoS = 1$.}
	\label{fig:mqtt_seq}
\end{figure}
