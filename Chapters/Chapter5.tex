...
Para la configuración inicial el módulo genera un Access Point WiFi 
...
Como parte del diseño del sistema se eligió el protocolo HTTP para el intercambio de mensajes entre el módulo y la app.
