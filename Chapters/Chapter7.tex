...
Teniendo en cuenta la criticidad de los algoritmos implementados para la capa de datos y la lógica de negocios en la capa de dominio. Se escribieron pruebas unitarias para ambas capas. En la figura %~\ref{} se muestra el reporte de ejecución de los casos de prueba. Sobre un total de Se consiguió la ejecución exitosa del total de  
